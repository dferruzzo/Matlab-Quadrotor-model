% Arquivo principal da simula√ß√£o
% ------------------------------
clear;
close all;
%%
...
g = 9.8;    % acelera√ß√£o da gravedade
m = 1.0428;      % massa total do ve√≠culo
Ixx = 1e-2;
Iyy = 1e-2;
Izz = 1.8e-2;
Ir = 1e-3;
Omega_r = 0;
% TransformaÁ„o U1,...,U4 -> freq. angulares dos motores
...
% sem limitaÁ„o dos motores por enquanto 08/11/2022
%rpm_max = 15400;
%rpm_min = 8700;
...
incluir_din_motor = -1;
%% CondiÁıes iniciais
% Condi√ß√µes iniciais p,q,r
p0 = 0;
q0 = 0;
r0 = 0;
% Condi√ß√µes iniciais √¢ngulos de Euler
phi0 = 0;
theta0 = 0;
psi0 = 0;
% Condi√ß√µes iniciais para as velocidades translacionais
vx0 = 0;
vy0 = 0;
vz0 = 0;
% Condi√ß√µes iniciais para as posi√ß√µes
x0 = 0;
y0 = 0;
z0 = 1;
%% Par√¢metros
...
A22 = A(7:12,7:12);
B22 = B(7:12,2:4);
% testando a controlabilidade da din√¢mica rotacional
% tem que ser 6
disp('Controlabilidade do sistema (A22,B22)');
disp(rank(ctrb(A22,B22)));
% dinÍmica rotacional no corpo w = (p,q,r)
Aw = A22(1:3,1:3);
Bw = B22(1:3,1:3);
Cw = eye(3);
Dw = zeros(3);
